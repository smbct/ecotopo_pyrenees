...
Notre dernière sortie avait pour but d'expérimenter l'utilisation le vélo pour monter en altitude afin d'atteindre un départ de randonnée et de marcher donc ensuite avant de redescendre.

## Le plateau de Beille

Le plateau de Beille est une station de ski nordique ⛷️ situées en Ariège.
On y accède par une route qui part des Cabannes.
Il s'agit d'une montée de 1200 mètres de dénivelés avec une pente maximale de 10% 😮‍💨.
Cet itinéraire est en fait populaire auprès des cyclistes, il s'agissait de l'arrivée du tour de France 2024, il y a quelques mois donc. 
...
Pour cette sortie, nous décidons de rejoindre la gare de Foix en train 🚆 depuis Toulouse avec nos vélos 🚲.
...
Notre trajet en train depuis Toulouse se passe sans encombre malgré un nombre important de vélo qui nous contraint à dépasser la limite imposée de 3 vélos par emplacement (nous dépassons finalement souvent ce nombre car il n'y a pas de réservation de vélo en place, sauf période estivale cette année 🎫).
En fait, nous effectuons cette sortie lors du premier weekend du mois, ce qui implique que le train est à 1€ dans la région 🤑 !
Autre explication au nombre de voyageurs : l'été est déjà loin et il s'agit probablement d'un des derniers weekends pour profiter du beau temps ⛅.
...
Pour l'occasion nous emmenons nos vélos légers et performants afin de faciliter la tâche (gravel de mon côté et vélo de course pour mon binôme).
Les vélos sont équipés de porte-bagage, ce qui nous permet d'y placer nos sacs de marche.
...
Le premier col se passe bien ! Environ 500 mètres à gravir, un peu d'essoufflement et une pause nécessaire me concernant peu de temps avant le "sommet", mais le double plateau me permet de monter sans trop forcer.
...
Il s'agit de mes premières expériences en montagne, autant dire que je ne suis pas serein !
...
Erreur de ma part, je n'ai pas prévu de nourriture (type barre de céréales) sur moi 🥫 ! 
Heureusement j'ai au moins une gourde remplie d'eau sur le porte gourde 🚰 !

## La montée vers le plateau

Nous commençons donc ensuite la montée !
Assez rapidement, je me rend compte que je n'ai presque plus de batterie sur mon téléphone 🪫.
Je comprend alors que c'est l'option enregistrement de l'application Komoot activée qui l'a vidé !
Je décide donc d'éteindre toutes les options afin d'économiser le peu qu'il me reste.
Il faut savoir que ça n'est pas gênant pour l'itinéraire car des balises indiquent régulièrement le kilomètre le long de la route (ainsi que le dénivelé de la montée).
...
La première : une douleur aux genoux commence à arriver.
Je suis convaincu qu'il s'agit du syndrome de [l'essuie-glace](https://www.passeportsante.net/fr/Maux/Problemes/Fiche.aspx?doc=syndrome-essuie-glace-causes-symptomes-traitements), une douleur que je connais bien car déjà rencontrée quelques fois en course, randonnée et à vélo 🤕.
En plus de cela, la difficulté à tenir le rythme au niveau des jambes me contraint à faire des pauses ⏸️ très régulières, alors que mon binôme file vers le sommet 🚀.
...
Pas loin d'abandonnée la monter 🏳️, je décide donc de faire une pause plus longue 🕙 et m'arrête dans un large virage hors de la route.
...
Je fini par arriver péniblement au sommet avec une bonne grosse douleur au genou ! Soulagement !
...
Je retrouve mon binôme qui commençait à s'inquiéter étant donné les 30 minutes de différence entre nos arrivées respectives ⏲️.
...
Nous passons ensuite à la deuxième étape de notre plan : la randonnée au plateau !
...
Je laisse mon binôme partir devant étant donné que je prévois déjà de prendre mon temps.
...
Dans tous les cas, ça a été une expérience sur-réelle pour moi qui est habitué à redescendre des randonnées tranquillement 🌌.

J'arrive en bas de la route après plus de 30 minutes de descente.
Je rejoins ensuite mon binôme et nous nous dirigeons tranquillement vers la gare.
...
Également, il s'agit de ne pas griller les étapes et d'affronter les challenges progressivement 🪜.
